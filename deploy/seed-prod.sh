#!/usr/bin/env bash
# ============================================================
# Carga datos demo en producción (Debian/Ubuntu)
# Uso:  bash deploy/seed-prod.sh
# ============================================================
set -euo pipefail
...
echo "==> Usuarios (auth)"
docker exec -i maquinaria-auth-db-1 psql -U postgres -d rentamaq_auth <<SQL
...
echo "==> Maquinaria (machinery)"
docker exec -i maquinaria-machinery-db-1 psql -U postgres -d rentamaq_machinery <<'SQL'
...
echo "==> Imágenes (machinery)"
docker exec -i maquinaria-machinery-db-1 psql -U postgres -d rentamaq_machinery <<'SQL'
INSERT INTO imagen_maquinaria (id, maquinaria_id, url, orden, es_portada) VALUES
('c1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1200&q=80', 0, true),
('c1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1616432043562-3671ea2e5242?auto=format&fit=crop&w=1200&q=80', 0, true),
('c1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=1200&q=80', 0, true),
('c1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1200&q=80', 0, true),
('c1000000-0000-0000-0000-000000000005', 'b1000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=1200&q=80', 0, true),
('c2000000-0000-0000-0000-000000000001', 'b2000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1590759362144-e2e40b1546d7?auto=format&fit=crop&w=1200&q=80', 0, true),
('c2000000-0000-0000-0000-000000000002', 'b2000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1601581875209-610b84e22b42?auto=format&fit=crop&w=1200&q=80', 0, true),
('c2000000-0000-0000-0000-000000000003', 'b2000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1574958269340-fa927503f3dd?auto=format&fit=crop&w=1200&q=80', 0, true),
('c2000000-0000-0000-0000-000000000004', 'b2000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1575505586569-646b2ca898fc?auto=format&fit=crop&w=1200&q=80', 0, true),
('c2000000-0000-0000-0000-000000000005', 'b2000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1606761568499-6d2451b23c66?auto=format&fit=crop&w=1200&q=80', 0, true),
('c3000000-0000-0000-0000-000000000001', 'b3000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&w=1200&q=80', 0, true),
('c3000000-0000-0000-0000-000000000002', 'b3000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=1200&q=80', 0, true),
('c3000000-0000-0000-0000-000000000003', 'b3000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=1200&q=80', 0, true),
('c3000000-0000-0000-0000-000000000004', 'b3000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1624969862644-791f3dc98927?auto=format&fit=crop&w=1200&q=80', 0, true),
('c3000000-0000-0000-0000-000000000005', 'b3000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1590725140244-197786b0ee84?auto=format&fit=crop&w=1200&q=80', 0, true),
('c4000000-0000-0000-0000-000000000001', 'b4000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1590579491624-f98f36d4c763?auto=format&fit=crop&w=1200&q=80', 0, true),
('c4000000-0000-0000-0000-000000000002', 'b4000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=1200&q=80', 0, true),
('c4000000-0000-0000-0000-000000000003', 'b4000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1587124956665-4ff306bcd10e?auto=format&fit=crop&w=1200&q=80', 0, true),
('c4000000-0000-0000-0000-000000000004', 'b4000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=1200&q=80', 0, true),
('c4000000-0000-0000-0000-000000000005', 'b4000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1607453998774-d533f65dac99?auto=format&fit=crop&w=1200&q=80', 0, true),
('c5000000-0000-0000-0000-000000000001', 'b5000000-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=1200&q=80', 0, true),
('c5000000-0000-0000-0000-000000000002', 'b5000000-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1575575440034-0e6a2630e4fc?auto=format&fit=crop&w=1200&q=80', 0, true),
('c5000000-0000-0000-0000-000000000003', 'b5000000-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&w=1200&q=80', 0, true),
('c5000000-0000-0000-0000-000000000004', 'b5000000-0000-0000-0000-000000000004', 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=1200&q=80', 0, true),
('c5000000-0000-0000-0000-000000000005', 'b5000000-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=1200&q=80', 0, true)
ON CONFLICT (id) DO NOTHING;
SQL

echo "==> Catálogo de búsqueda (search)"
docker exec -i maquinaria-search-db-1 psql -U postgres -d rentamaq_search <<'SQL'
INSERT INTO maquinaria (id, propietario_id, titulo, descripcion, tipo, marca, modelo, anio, capacidad, estado, precio_por_dia, ubicacion_lat, ubicacion_lng, direccion, ciudad, departamento, disponible, activo)
VALUES
...
echo "==> Reservas (booking)"
docker exec -i maquinaria-booking-db-1 psql -U postgres -d rentamaq_booking <<'SQL'
...
echo "==> Pagos (payment)"
docker exec -i maquinaria-payment-db-1 psql -U postgres -d rentamaq_payment <<'SQL'
...
echo "==> Calificaciones (rating)"
docker exec -i maquinaria-rating-db-1 psql -U postgres -d rentamaq_rating <<'SQL'
...
echo "========================================"
echo "  ADMIN:       admin@rentamaq.com / test1234"
echo "  PROPIETARIOS: carlos@ / laura@ / pedro@ / ana@ / jorge@rentamaq.com  (test1234)"
echo "  ARRENDATARIOS: maria@ / andres@ / sofia@rentamaq.com  (test1234)"
echo "  Sitio: https://rentamaqu.online"
